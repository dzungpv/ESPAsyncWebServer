...
#ifndef WEBSERVER_H
typedef enum {
  HTTP_ASYNC_GET     = 0b00000001,
  HTTP_ASYNC_POST    = 0b00000010,
  HTTP_ASYNC_DELETE  = 0b00000100,
  HTTP_ASYNC_PUT     = 0b00001000,
  HTTP_ASYNC_PATCH   = 0b00010000,
  HTTP_ASYNC_HEAD    = 0b00100000,
  HTTP_ASYNC_OPTIONS = 0b01000000,
  HTTP_ASYNC_ANY     = 0b01111111,
} WebRequestMethod;
#endif
